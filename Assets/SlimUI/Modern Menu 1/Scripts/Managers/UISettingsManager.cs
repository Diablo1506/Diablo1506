...
namespace SlimUI.ModernMenu{
	public class UISettingsManager : MonoBehaviour {
		...
		public void Start()
		{
			// Check if difficultynormaltextLINE is assigned
			if (difficultynormaltextLINE == null)
			{
				Debug.LogError("difficultynormaltextLINE is not assigned in the Inspector.");
				return;
			}

			// Check if difficultyhardcoretextLINE is assigned
			if (difficultyhardcoretextLINE == null)
			{
				Debug.LogError("difficultyhardcoretextLINE is not assigned in the Inspector.");
				return;
			}
